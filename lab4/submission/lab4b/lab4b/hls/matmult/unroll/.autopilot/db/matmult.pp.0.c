...
# 4 "../../src_4b/matmult.c" 2

# 1 "../../src_4b/matmult.h" 1


void matmult(short int A[16][16],short int B[16][16],int C[16][16]);
# 6 "../../src_4b/matmult.c" 2

void matmult(short int A[16][16],short int B[16][16],int C[16][16]){_ssdm_SpecArrayDimSize(A, 16);_ssdm_SpecArrayDimSize(B, 16);_ssdm_SpecArrayDimSize(C, 16);
 int i, j, k;
    int sum = 0;

 for (i = 0; i < 16; i++){
        for(j = 0; j < 16; j++){
            matmult_label0:for(k = 0; k < 16; k++){
#pragma HLS UNROLL
# 13 "../../src_4b/matmult.c"
